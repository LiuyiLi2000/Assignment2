...
function draw() {
  ...
  text("Welcome! This is a fake live stream. ", windowWidth/2, 200);

  textSize(30);
  textAlign(LEFT);
  text("Do you mind tell Lulu your name?", windowWidth/3, 300);
 

  text("Do you mind tell Lulu your favourite color?", windowWidth/3, 420);
  textSize(20);
...
function sendTheMessage() {
  ...
  if (nameInput.value() != "") { 
    ...
    window.location.href = "/../pageTwo/index.html?you="+you+"&r="+redVal+"&g="+greenVal+"&b="+blueVal; 

  } else {
    // if they have no entered their name, create an alert and ask them to enter their name
    window.alert("Please tell me your name!");
  }
