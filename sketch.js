...
function draw() {
  ...
  background(255);
  text("Did someone entered the chat?", 800, 760);

 }else if (occupancy =2) {

    background(255);
    text("Oh now the second one entered the chat!", 800, 760);
  ...
  background(255);
  text("waiting for someone...", 800, 760); 
  allowmessage = false;
